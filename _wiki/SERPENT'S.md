---
layout: wiki
title: 蛇石（琐希列磐石）（SERPENT'S STONE）（AV 作 'Stone of Zoheleth'；来：~eb[en
hazzo{h]elet[）
categories: NewBibleDictionary
description: 蛇石（琐希列磐石）（SERPENT'S STONE）（AV 作 'Stone of Zoheleth'；来：~eb[en
hazzo{h]elet[）
keywords: 蛇石（琐希列磐石）（SERPENT'S STONE）（AV 作 'Stone of Zoheleth'；来：~eb[en
hazzo{h]elet[）
comments: false
---

## 蛇石（琐希列磐石）（SERPENT'S STONE）（AV 作 'Stone of Zoheleth'；来：~eb[en
hazzo{h]elet[）
